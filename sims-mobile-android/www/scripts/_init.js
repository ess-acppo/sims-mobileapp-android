...
var hostweed = '<div class="row col-md-12 hostweed collapsed"><i class="fa fa-arrow-circle-up fa-3x text-arrows collapse hide" data-action="collapse"></i><i class="fa fa-arrow-circle-down fa-3x expand text-arrows" data-action="expand"></i><div class="row col-md-12 col-sm-12 sims"><div class="form-group  col-md-2 col-sm-2"><span data-toggle="tooltip" title="" class="badge badge-success" data-original-title="1">1</span><label><span class="bold-red">*</span>Taxon ID</label><input type="text" class="form-control" placeholder="Host Name" name="PlantTaxonId"></div><div class="form-group  col-md-6 col-sm-6"><label><span class="bold-red">*</span>Host Name</label><input type="text" class="form-control" placeholder="Host Name" name="PlantTaxonText"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-3 col-sm-3"><input type="radio" class="minimal" name="CountList" value="Count" data-validate="N">&nbsp;<label>Count</label></div><div class="form-group col-md-3 col-sm-3"><input type="radio" class="minimal" name="CountList" value="List" data-validate="N">&nbsp;<label>List</label></div></div><div class="row col-md-12 col-sm-12 sims countArea hide"><div class="form-group col-md-6 col-sm-6"><label><span class="bold-red">*</span>Statistic Type</label><select class="form-control select2" name="PlantStatisticType"></select></div><div class="form-group col-md-6 col-sm-6"><label><span class="bold-red">*</span>Count/Area</label>&nbsp;<span data-toggle="tooltip" title="2" class="badge bg-grey" data-original-title="2">1</span><br /><button type="button" class="btn btn-md btn-default qtyminus"><i class="fa fa-minus"></i></button><input type="number" class="qty" name="HostStatCount" value="0"><input type="number" class="qty" name="HostStatAreaNo" value="0"><button type="button" class="btn btn-md btn-default qtyplus"><i class="fa fa-plus"></i></button></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="CheckFutureSurveyFlag" class="minimal">&nbsp;<label>Flag</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="ExternalPhotoExistFlag" class="minimal">&nbsp;<label>External Photo</label></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Latitude</label><input type="number" class="form-control hostweedlat" name="Latitude" placeholder="Latitude" readonly></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Longitude</label><input type="number" class="form-control hostweedlng" name="Longitude" placeholder="Longitude" readonly></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Point WKT<span class="bold-red">*</span></label><input type="text" class="form-control" readonly name="LocationPointWktClob"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Datum</label><select class="form-control" name="GpsDatumId"><option>WGS84</option><option>GDA94</option></select></div><div class="form-group col-md-3 col-sm-3"><button class="btn btn-md btn-default getPlantCoords"><i class="fa fa-map-marker text-info"></i>&nbsp;Get Coordinates</button></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Notes</label><textarea class="form-control" rows="6" name="CommentText" style="height:60px;"></textarea></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-12 col-sm-12"><img class="pp" src="images/plant.png" id="plantPic1"><input type="text" class="hide" id="iplantPic1" value="x"><img class="pp" src="images/plant.png" id="plantPic2"><input type="text" class="hide" id="iplantPic2" value="x"><img class="pp" src="images/plant.png" id="plantPic3"><input type="text" class="hide" id="iplantPic3" value="x"><img class="pp" src="images/plant.png" id="plantPic4"><input type="text" class="hide" id="iplantPic4" value="x"><img class="pp" src="images/plant.png" id="plantPic5"><input type="text" class="hide" id="iplantPic5" value="x"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-12 col-sm-12"><i class="fa fa-trash text-danger fa-2x pull-right removePlant" data-action="removePlant"></i></div></div></div>';
var botSample = '<div class="row col-md-12 col-sm-12 sims dynarow sample collapsed"><i class="fa fa-arrow-circle-up fa-3x text-arrows collapse hide" data-action="collapse"></i><i class="fa fa-arrow-circle-down fa-3x expand text-arrows" data-action="expand"></i><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-4 col-sm-4"><label>Sample Field ID <span class="bold-red">*</span></label><input type="text" class="form-control nextid" placeholder="Sample Field ID" name="SampleFieldLabelText" readonly></div><div class="form-group col-md-7"><label>Additional Collectors</label><br /><input type="checkbox" name="AdditionalCollectorTab" class="minimal"></div></div><div class="row col-md-12 col-sm-12 sims addlCollectors hide"><div class="form-group col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 1" name="collector1"></div><div class="form-group col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 2" name="collector2"></div><div class="form-group col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 3" name="collector3"></div></div><div class="row col-md-12 col-sm-12 sims addlCollectors hide"><div class="form-group col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 4" name="collector4"></div><div class="form-group col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 5" name="collector5"></div><div class="form-group col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 6" name="collector6"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Number Collected <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Number Collected" name="CollectedSampleCount"></div><div class="form-group col-md-6 col-sm-6"><label>Linked Sample #</label><input type="text" class="form-control" placeholder="Linked Sample #" name="LinkedSampleFieldLabelText"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Preliminary Taxon ID <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Preliminary ID" name="PrelimTaxonId"></div><div class="form-group col-md-6 col-sm-6"><label>Preliminary Taxon Text <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Preliminary ID" name="PrelimTaxonText"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Latitude <span class="bold-red">*</span></label><input type="number" class="form-control samplelat" placeholder="Latitude" name="latitude" readonly></div><div class="form-group col-md-6 col-sm-6"><label>Longitude <span class="bold-red">*</span></label><input type="number" class="form-control samplelng" placeholder="Longitude" name="longitude" readonly></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Point WKT<span class="bold-red">*</span></label><input type="text" class="form-control" readonly name="SamplePointWktClob"></div><div class="form-group col-md-3 col-sm-3"><label>Datum</label><select class="form-control" name="GpsDatumId"><option>WGS84</option><option>GDA94</option></select></div><div class="form-group col-md-3 col-sm-3"><button class="btn btn-md btn-default getSampleCoords"><i class="fa fa-map-marker text-info"></i>&nbsp;Get Coordinates</button></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Time</label><input type="text" class="form-control" placeholder="Time" name="CollectedDatetime"></div><div class="form-group col-md-6 col-sm-6"><label>Altitude</label><input type="text" class="form-control samplealt" placeholder="Altitude" name="CollectedAltitudeNo" readonly></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-12 col-sm-12"><label>Additional Comments</label><textarea class="form-control" rows="6" name="CommentText" style="height:60px;"></textarea></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Identified By</label><select class="form-control" name="HostIdentifiedUserId"></select></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-4 col-sm-4"><label>Habit <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Habit" name="HabitText"></div><div class="form-group col-md-4 col-sm-4"><label>Description <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Description" name="DetailedDescriptionText"></div><div class="form-group col-md-4 col-sm-4"><label>Habitat <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Habitat" name="HabitatText"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-4 col-sm-4"><label>Landform <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="LandForm" name="LandformText"></div><div class="form-group col-md-4 col-sm-4"><label>Soil/Geology <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Soil/Geology" name="SoilGeologyText"></div><div class="form-group col-md-4 col-sm-4"><label>Abundance</label><input type="text" class="form-control" placeholder="Abundance" name="AbundanceText"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-2"><label>Preservation Type</label></div><div class="form-group col-md-3 col-sm-3"><input type="checkbox" name="PlantPreservationTab-SP" class="minimal" data-attr="PlantPreservationTab" data-code="SP" data-desc="Spirit Sample" data-seq="1">&nbsp;<label>Spirit Sample</label></div><div class="form-group col-md-3 col-sm-3"><input type="checkbox" name="PlantPreservationTab-DN" class="minimal" data-attr="PlantPreservationTab" data-code="DN" data-desc="DNA Sample" data-seq="2">&nbsp;<label>DNA Sample</label></div><div class="form-group col-md-4 col-sm-4"><input type="checkbox" name="PlantPreservationTab-O" class="minimal" data-attr="PlantPreservationTab" data-code="O" data-desc="Other" data-seq="3">&nbsp;<label>Other</label>&nbsp;<input type="text" class="form-control hide" placeholder="Other Text" name="BotPlantPreserverOtherText"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-12 col-sm-12"><input type="checkbox" name="ExternalPhotoExistFlag" class="minimal">&nbsp;&nbsp;<label>Photo(s) taken using external camera</label></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-12 col-sm-12"><i class="fa fa-trash fa-2x text-danger pull-right removeBotSample"></i></div></div></div>';
...
var entobox = '<div class="row col-md-12 col-sm-12 entobox collapsed"><i class="fa fa-arrow-circle-up fa-3x text-arrows collapse hide" data-action="collapse"></i><i class="fa fa-arrow-circle-down fa-3x expand text-arrows" data-action="expand"></i><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-2 col-sm-2"><span data-toggle="tooltip" title="" class="badge badge-success badge-host" data-original-title="1">1</span><label><span class="bold-red">*</span>Taxon ID</label><input type="text" class="form-control" placeholder="Host Name" name="PlantTaxonId"></div><div class="form-group  col-md-6 col-sm-6"><label><span class="bold-red">*</span>Host Name</label><input type="text" class="form-control" placeholder="Host Name" name="PlantTaxonText"></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label><span class="bold-red">*</span>Statistic Type</label><select class="form-control select2" name="PlantStatisticType"></select></div><div class="form-group  col-md-6 col-sm-6"><label><span class="bold-red">*</span>Count/Area</label>&nbsp;<span data-toggle="tooltip" title="2" class="badge bg-grey" data-original-title="2">1</span><br /><button type="button" class="btn btn-md btn-default qtyminus"><i class="fa fa-minus"></i></button><input type="number" class="qty" name="HostStatCount" value="0"><input type="number" class="qty" name="HostStatAreaNo" value="0"><button type="button" class="btn btn-md btn-default qtyplus"><i class="fa fa-plus"></i></button></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="CheckFutureSurveyFlag" class="minimal">&nbsp;<label>Flag</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="ExternalPhotoExistFlag" class="minimal">&nbsp;<label>External Photo</label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label><span class="bold-red">*</span>Method of Observation</label><select class="form-control" name="PlantObsMethodCode"></select></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Notes</label><textarea class="form-control" rows="6" name="CommentText" style="height:60px;"></textarea></div></div><div class="row col-md-12 col-sm-12 sims bg-target entotarget"><i class="fa fa-plus fa-2x text-arrows text-info" data-action="addEntoTarget"></i><div class="form-group col-md-2 col-sm-2"><span data-toggle="tooltip" title="" class="badge badge-success badge-target" data-original-title="1">1</span><label>Target Taxon Id</label><input type="text" name="TargetTaxonId" class="input-sm form-control" placeholder="Target Taxon ID"></div><div class="form-group col-md-6 col-sm-6"><label>Target Taxon Name</label><input type="text" name="TargetTaxonText" class="input-sm form-control" placeholder="Target Taxon Text"></div><div class="form-group col-md-2 col-sm-2"><label>Target Count</label><input type="text" name="TargetCount" class="input-sm form-control" placeholder="Target Count"></div><div class="form-group col-md-3 col-sm-3"><input type="radio" class="minimal" name="TargetObservedCode" id="optA" value="A">&nbsp;<label>Not Observed</label></div><div class="form-group col-md-3 col-sm-3"><input type="radio" class="minimal" name="TargetObservedCode" id="optP" value="P">&nbsp;<label>Present</label></div><div class="form-group col-md-3 col-sm-3"><input type="radio" class="minimal" name="TargetObservedCode" id="optS" value="S">&nbsp;<label>Suspected</label></div><div class="form-group col-md-3 col-sm-3"><input type="radio" class="minimal" name="TargetObservedCode" id="optND" value="N">&nbsp;<label>Not Done</label></div><div class="form-group col-md-12 col-sm-12"><label>Comments</label><input type="text" name="CommentText" class="input-sm form-control" placeholder="Comments"></div><div class="form-group col-md-12 col-sm-12 border-bottom-dark"><i class="fa fa-trash fa-2x text-danger pull-right" data-action="removeEntoTarget"></i></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Life Stage</label><select class="form-control select2" name="PlantLifeStgCode" style="width: 100%;"></select></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Host Plant Status</label></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-3 col-sm-3"><input type="checkbox" name="PlantStatusFruitingFlag" class="minimal" value="FR">&nbsp;<label>Fruiting</label></div><div class="form-group col-md-3 col-sm-3"><input type="checkbox" name="PlantStatusFloweringFlag" class="minimal" value="FL">&nbsp;<label>Flowering</label></div><div class="form-group col-md-3 col-sm-3"><input type="checkbox" name="PlantStatusFlushing_Flag" class="minimal" value="FU">&nbsp;<label>Flushing</label></div><div class="form-group col-md-3 col-sm-3"><input type="checkbox" name="PlantStatusDeadWood_Flag" class="minimal" value="DE">&nbsp;<label>Deadwood</label></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Latitude</label><input type="number" class="form-control entolat" name="Latitude" placeholder="Latitude" readonly></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Longitude</label><input type="number" class="form-control entolng" name="Longitude" placeholder="Longitude" readonly></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Point WKT<span class="bold-red">*</span></label><input type="text" class="form-control" readonly name="LocationPointWktClob"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Datum</label><select class="form-control" name="GpsDatumId"><option>WGS84</option><option>GDA94</option></select></div><div class="form-group col-md-3"><button class="btn btn-md btn-default getEntoHostCoords"><i class="fa fa-map-marker text-info"></i>&nbsp;Get Coordinates</button></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-12 col-sm-12"><img class="pp" src="images/plant.png" id="plantPic1"><input type="text" class="hide" id="iplantPic1" value="x"><img class="pp" src="images/plant.png" id="plantPic2"><input type="text" class="hide" id="iplantPic2" value="x"><img class="pp" src="images/plant.png" id="plantPic3"><input type="text" class="hide" id="iplantPic3" value="x"><img class="pp" src="images/plant.png" id="plantPic4"><input type="text" class="hide" id="iplantPic4" value="x"><img class="pp" src="images/plant.png" id="plantPic5"><input type="text" class="hide" id="iplantPic5" value="x"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-12 col-sm-12"><i class="fa fa-trash text-danger fa-2x pull-right removeEntoHost" data-action="removeEntoHost"></i></div></div></div>';
...
var entosample = '<div class="row  col-md-12 col-sm-12 sims dynarow sample collapsed"><i class="fa fa-arrow-circle-up fa-3x text-arrows collapse hide" data-action="collapse"></i><i class="fa fa-arrow-circle-down fa-3x expand text-arrows" data-action="expand"></i><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-3 col-sm-3"><label>Sample Field ID <span class="bold-red">*</span></label><input type="text" class="form-control nextid" placeholder="Sample Field ID" name="SampleFieldLabelText" readonly></div><div class="form-group  col-md-3 col-sm-3"><label>Additional Collectors</label><br /><input type="checkbox" name="AdditionalCollectorTab" class="minimal"></div></div><div class="row  col-md-12 col-sm-12 sims addlCollectors hide"><div class="form-group  col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 1" name="collector1"></div><div class="form-group  col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 2" name="collector2"></div><div class="form-group  col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 3" name="collector3"></div></div><div class="row  col-md-12 col-sm-12 sims addlCollectors hide"><div class="form-group  col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 4" name="collector4"></div><div class="form-group  col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 5" name="collector5"></div><div class="form-group  col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 6" name="collector6"></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Number Collected <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Number Collected" name="CollectedSampleCount"></div><div class="form-group  col-md-6 col-sm-6"><label>Linked Sample #</label><input type="text" class="form-control" placeholder="Linked Sample #" name="LinkedSampleFieldLabelText"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Preliminary ID <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Preliminary ID" name="PrelimTaxonId"></div><div class="form-group col-md-6 col-sm-6"><label>Preliminary Taxon Text <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Preliminary ID" name="PrelimTaxonText"></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Latitude <span class="bold-red">*</span></label><input type="number" class="form-control samplelat" placeholder="Latitude" name="latitude" readonly></div><div class="form-group col-md-6 col-sm-6"><label>Longitude <span class="bold-red">*</span></label><input type="number" class="form-control samplelng" placeholder="Longitude" name="longitude" readonly></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Point WKT<span class="bold-red">*</span></label><input type="text" class="form-control" readonly name="SamplePointWktClob"></div><div class="form-group col-md-3 col-sm-3"><label>Datum</label><select class="form-control" name="GpsDatumId"><option>WGS84</option><option>GDA94</option></select></div><div class="form-group col-md-3 col-sm-3"><button class="btn btn-md btn-default getSampleCoords"><i class="fa fa-map-marker text-info"></i>&nbsp;Get Coordinates</button></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-4 col-sm-4"><label>Time</label><input type="text" class="form-control" placeholder="Time" name="CollectedDatetime"></div><div class="form-group  col-md-4 col-sm-4"><label>Altitude</label><input type="text" class="form-control samplealt" placeholder="Altitude" name="CollectedAltitudeNo" readonly></div><div class="form-group  col-md-4 col-sm-4"><label>Collection Method</label><select class="form-control" name="EntoCollMethodCode"></select></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-12 col-sm-12"><label>Additional Comments</label><textarea class="form-control" rows="6" name="CommentText" style="height:30px;"></textarea></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group col-md-6"><label>Host/Other <span class="bold-red">*</span></label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group col-md-3 col-sm-3"><input type="radio" name="HostFlag" class="minimal" value="host">&nbsp;<label>Host</label></div><div class="form-group col-md-3 col-sm-3"><input type="radio" name="HostFlag" class="minimal" value="other">&nbsp;<label>Other</label></div><div class="form-group  col-md-3 col-sm-3"><label>Host/Other Taxon Id</label><input type="text" class="form-control" placeholder="Other Name" name="HostTaxonId"></div><div class="form-group  col-md-3 col-sm-3"><label>Host/Other Taxon Text</label><input type="text" class="form-control" placeholder="Other Name" name="HostTaxonText"></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-4 col-sm-4"><label>Identified By</label><select class="form-control" name="HostIdentifiedUserId"></select></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Plant Part</label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPartTab-LE" class="minimal" value="LE">&nbsp;<label>Leaves</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPartTab-FL" class="minimal" value="FL">&nbsp;<label>Flower</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPartTab-FR" class="minimal" value="FR">&nbsp;<label>Fruit</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPartTab-SE" class="minimal" value="SE">&nbsp;<label>Seeds</label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPartTab-ST" class="minimal" value="ST">&nbsp;<label>Stem</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPartTab-SH" class="minimal" value="SH">&nbsp;<label>Shoot</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPartTab-RO" class="minimal" value="RO">&nbsp;<label>Root</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPartTab-BR" class="minimal" value="BR">&nbsp;<label>Branch</label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPartTab-TR" class="minimal" value="TR">&nbsp;<label>Trunk</label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Preservation Type</label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPreservationTab-W7" class="minimal" value="W7">&nbsp;<label>Wet (Ethanol 70-80%)</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPreservationTab-W8" class="minimal" value="W8">&nbsp;<label>Wet (Ethanol>80%)</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPreservationTab-RE" class="minimal" value="RE">&nbsp;<label>Rearing</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPreservationTab-DR" class="minimal" value="DR">&nbsp;<label>Dry</label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPreservationTab-FT" class="minimal" value="FT">&nbsp;<label>FTA Card</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPreservationTab-O" class="minimal" value="O">&nbsp;<label>Other</label></div><div class="form-group col-md-3 col-sm-3"><input type="text" class="form-control" placeholder="Other Preservation Type" name="PlantPreservOtherText"></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-4 col-sm-4"><label>%Infested </label><select class="form-control" name="EntoInfestedPctCode"></select></div><div class="form-group  col-md-4 col-sm-4"><label>Damage Level </label><select class="form-control" name="EntoDamageLevelCode"></select></div><div class="form-group  col-md-4 col-sm-4"><label>Pest Level </label><select class="form-control" name="EntoPestLevelCode"></select></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Life Stage</label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="EntoLifeStgTab-A" class="minimal" value="A">&nbsp;<label>Adult</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="EntoLifeStgTab-E" class="minimal" value="E">&nbsp;<label>Egg</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="EntoLifeStgTab-I" class="minimal" value="I">&nbsp;<label>Immature</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="EntoLifeStgTab-P" class="minimal" value="P">&nbsp;<label>Pupae</label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-12 col-sm-12"><input type="checkbox" name="ExternalPhotoExistFlag" class="minimal">&nbsp;&nbsp;<label>Photo(s) taken using external camera</label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-12 col-sm-12">&nbsp;<i class="fa fa-trash fa-2x text-danger pull-right removeEntoSample"></i></div></div></div>';
var numEntoHosts = 0;
...
var pathbox = '<div class="row  col-md-12 col-sm-12 pathbox collapsed"><i class="fa fa-arrow-circle-up fa-3x text-arrows collapse hide" data-action="collapse"></i><i class="fa fa-arrow-circle-down fa-3x expand text-arrows" data-action="expand"></i><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-2 col-sm-2"><span data-toggle="tooltip" title="" class="badge badge-success badge-host" data-original-title="1">1</span><label><span class="bold-red">*</span>Taxon ID</label><input type="text" class="form-control" placeholder="Taxon ID" name="PlantTaxonId"></div><div class="form-group  col-md-6 col-sm-6"><label><span class="bold-red">*</span>Host Name</label><input type="text" class="form-control" placeholder="Taxon Text" name="PlantTaxonText"></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label><span class="bold-red">*</span>Statistic Type</label><select class="form-control select2" name="PlantStatisticType"></select></div><div class="form-group  col-md-6 col-sm-6"><label><span class="bold-red">*</span>Count/Area</label>&nbsp;<span data-toggle="tooltip" title="2" class="badge bg-grey" data-original-title="2">1</span><br /><button type="button" class="btn btn-md btn-default qtyminus"><i class="fa fa-minus"></i></button><input type="number" class="qty" name="HostStatCount" value="0"><input type="number" class="qty" name="HostStatAreaNo" value="0"><button type="button" class="btn btn-md btn-default qtyplus"><i class="fa fa-plus"></i></button></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="CheckFutureSurveyFlag" class="minimal">&nbsp;<label>Flag</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="ExternalPhotoExistFlag" class="minimal">&nbsp;<label>External Photo</label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label><span class="bold-red">*</span>Method of Observation</label><select class="form-control" name="PlantObsMethodCode"></select></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Notes</label><textarea class="form-control" rows="6" name="CommentText" style="height:60px;"></textarea></div></div><div class="row  col-md-12 col-sm-12 sims bg-target pathtarget"><i class="fa fa-plus fa-2x text-arrows text-info" data-action="addPathTarget"></i><div class="form-group col-md-2 col-sm-2"><span data-toggle="tooltip" title="" class="badge badge-success badge-target" data-original-title="1">1</span><label>Target Taxon ID</label><input type="text" name="TargetTaxonId" class="input-sm form-control" placeholder="Target Taxon ID"></div><div class="form-group col-md-6 col-sm-6"><label>Target Taxon Name</label><input type="text" name="TargetTaxonText" class="input-sm form-control" placeholder="Target Taxon Text"></div><div class="form-group col-md-2 col-sm-2"><label>Target Count</label><input type="text" name="TargetCount" class="input-sm form-control" placeholder="Target Count"></div><div class="form-group col-md-3 col-sm-3"><input type="radio" class="minimal" name="TargetObservedCode" id="optA" value="A">&nbsp;<label>Not Observed</label></div><div class="form-group col-md-3 col-sm-3"><input type="radio" class="minimal" name="TargetObservedCode" id="optP" value="P">&nbsp;<label>Present</label></div><div class="form-group col-md-3 col-sm-3"><input type="radio" class="minimal" name="TargetObservedCode" id="optS" value="S">&nbsp;<label>Suspected</label></div><div class="form-group col-md-3 col-sm-3"><input type="radio" class="minimal" name="TargetObservedCode" id="optND" value="N">&nbsp;<label>Not Done</label></div><div class="form-group col-md-12 col-sm-12"><label>Comments</label><input type="text" name="CommentText" class="input-sm form-control" placeholder="Comments"></div><div class="form-group col-md-12 col-sm-12 border-bottom-dark"><i class="fa fa-trash fa-2x text-danger pull-right" data-action="removePathTarget"></i></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Life Stage</label><select class="form-control select2" name="PlantLifeStgCode" style="width: 100%;"></select></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Latitude</label><input type="number" class="form-control pathlat" name="Latitude" placeholder="Latitude" readonly></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Longitude</label><input type="number" class="form-control pathlng" name="Longitude" placeholder="Longitude" readonly></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Point WKT<span class="bold-red">*</span></label><input type="text" class="form-control" readonly name="LocationPointWktClob"></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Datum</label><select class="form-control" name="GpsDatumId"><option>WGS84</option><option>GDA94</option></select></div><div class="form-group  col-md-3 col-sm-3  col-md-3 col-sm-3"><button class="btn btn-md btn-default getPathHostCoords"><i class="fa fa-map-marker text-info"></i>&nbsp;Get Coordinates</button></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-12 col-sm-12"><img class="pp" src="images/plant.png" id="plantPic1"><input type="text" class="hide" id="iplantPic1" value="x"><img class="pp" src="images/plant.png" id="plantPic2"><input type="text" class="hide" id="iplantPic2" value="x"><img class="pp" src="images/plant.png" id="plantPic3"><input type="text" class="hide" id="iplantPic3" value="x"><img class="pp" src="images/plant.png" id="plantPic4"><input type="text" class="hide" id="iplantPic4" value="x"><img class="pp" src="images/plant.png" id="plantPic5"><input type="text" class="hide" id="iplantPic5" value="x"></div></div><div class="row  col-md-12 col-sm-12  col-md-12 col-sm-12 sims"><div class="form-group  col-md-12 col-sm-12  col-md-12 col-sm-12"><i class="fa fa-trash text-danger fa-2x pull-right removePathHost" data-action="removePathHost"></i></div></div></div>';
...
var pathsample = '<div class="row  col-md-12 col-sm-12 sims dynarow sample collapsed"><i class="fa fa-arrow-circle-up fa-3x text-arrows collapse hide" data-action="collapse"></i><i class="fa fa-arrow-circle-down fa-3x expand text-arrows" data-action="expand"></i><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-3 col-sm-3"><label>Sample Field ID <span class="bold-red">*</span></label><input type="text" class="form-control nextid" placeholder="Sample Field ID" name="SampleFieldLabelText"></div><div class="form-group  col-md-3 col-sm-3"><label>Additional Collectors</label><br /><input type="checkbox" name="addlCollectors" class="minimal"></div></div><div class="row  col-md-12 col-sm-12 sims addlCollectors hide"><div class="form-group  col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 1" name="collector1"></div><div class="form-group  col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 2" name="collector2"></div><div class="form-group  col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 3" name="collector3"></div></div><div class="row  col-md-12 col-sm-12 sims addlCollectors hide"><div class="form-group  col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 4" name="collector4"></div><div class="form-group  col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 5" name="collector5"></div><div class="form-group  col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 6" name="collector6"></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-4 col-sm-4"><label>Number Collected <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Number Collected" name="CollectedSampleCount"></div><div class="form-group  col-md-4 col-sm-4"><label>Linked Sample #</label><input type="text" class="form-control" placeholder="Linked Sample #" name="LinkedSampleFieldLabelText"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Preliminary ID <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Preliminary ID" name="PrelimTaxonId"></div><div class="form-group col-md-6 col-sm-6"><label>Preliminary Taxon Text <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Preliminary ID" name="PrelimTaxonText"></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Latitude <span class="bold-red">*</span></label><input type="number" class="form-control samplelat" placeholder="Latitude" name="latitude" readonly></div><div class="form-group col-md-6 col-sm-6"><label>Longitude <span class="bold-red">*</span></label><input type="number" class="form-control samplelng" placeholder="Longitude" name="longitude" readonly></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Point WKT<span class="bold-red">*</span></label><input type="text" class="form-control" readonly name="SamplePointWktClob"></div><div class="form-group col-md-3 col-sm-3"><label>Datum</label><select class="form-control" name="GpsDatumId"><option>WGS84</option><option>GDA94</option></select></div><div class="form-group col-md-3 col-sm-3"><button class="btn btn-md btn-default getSampleCoords"><i class="fa fa-map-marker text-info"></i>&nbsp;Get Coordinates</button></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Time</label><input type="text" class="form-control" placeholder="Time" name="CollectedDatetime"></div><div class="form-group  col-md-6 col-sm-6"><label>Altitude</label><input type="text" class="form-control samplealt" placeholder="Altitude" name="CollectedAltitudeNo" readonly></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-12 col-sm-12"><label>Additional Comments</label><textarea class="form-control" rows="6" name="CommentText" style="height:30px;"></textarea></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Host/Other <span class="bold-red">*</span></label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><input type="radio" name="HostFlag" class="minimal" value="host">&nbsp;<label>Host</label></div><div class="form-group col-md-6 col-sm-6"><input type="radio" name="HostFlag" class="minimal" value="other">&nbsp;<label>Other</label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Host/Other Taxon Id</label><input type="text" class="form-control" placeholder="Other Name" name="HostTaxonId"></div><div class="form-group col-md-6 col-sm-6"><label>Host/Other Taxon Text</label><input type="text" class="form-control" placeholder="Other Name" name="HostTaxonText"></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Identified By</label><select class="form-control" name="HostIdentifiedUserId"></select></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Plant Part</label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPartTab-LE" class="minimal" value="LE">&nbsp;<label>Leaves</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPartTab-FL" class="minimal" value="FL">&nbsp;<label>Flower</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPartTab-FR" class="minimal" value="FR">&nbsp;<label>Fruit</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPartTab-SE" class="minimal" value="SE">&nbsp;<label>Seeds</label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPartTab-ST" class="minimal" value="ST">&nbsp;<label>Stem</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPartTab-SH" class="minimal" value="SH">&nbsp;<label>Shoot</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPartTab-RO" class="minimal" value="RO">&nbsp;<label>Root</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPartTab-BR" class="minimal" value="BR">&nbsp;<label>Branch</label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPartTab-TR" class="minimal" value="TR">&nbsp;<label>Trunk</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPartTab-WP" class="minimal" value="WP">&nbsp;<label>Whole Plant</label></div><div class="form-group  col-md-3 col-sm-3"><input type="checkbox" name="PlantPartTab-SO" class="minimal" value="SO">&nbsp;<label>Soil</label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-12 col-sm-12"><label>Symptoms</label><input type="text" class="form-control" placeholder="Symptoms" name="PathSymptomsText"></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Preservation Type <span class="bold-red">*</span></label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-4 col-sm-4"><input type="checkbox" name="PlantPreservationTab-FR" class="minimal" value="FR">&nbsp;<label>Fresh</label></div><div class="form-group  col-md-4 col-sm-4"><input type="checkbox" name="PlantPreservationTab-PR" class="minimal" value="PR">&nbsp;<label>Pressed Specimen</label></div><div class="form-group  col-md-4 col-sm-4"><input type="checkbox" name="PlantPreservationTab-DE" class="minimal" value="DE">&nbsp;<label>Dessicate</label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-4 col-sm-4"><input type="checkbox" name="PlantPreservationTab-EX" class="minimal" value="EX">&nbsp;<label>Extract</label></div><div class="form-group  col-md-4 col-sm-4"><input type="checkbox" name="PlantPreservationTab-IS" class="minimal" value="IS">&nbsp;<label>Isolation</label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-4 col-sm-4"><input type="checkbox" name="PlantPreservationTab-O" class="minimal" value="O">&nbsp;<label>Other</label></div><div class="form-group  col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Other Preservation Type" name="PlantPreservOtherText" readonly></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Incidence <span class="bold-red">*</span></label><select class="form-control" name="PathIncidCode"></select></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-6 col-sm-6"><label>Severity <span class="bold-red">*</span></label><select class="form-control" name="PathSevCode"></select></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-12 col-sm-12"><input type="checkbox" name="ExternalPhotoExistFlag" class="minimal">&nbsp;&nbsp;<label>Photo(s) taken using external camera</label></div></div><div class="row  col-md-12 col-sm-12 sims"><div class="form-group  col-md-12 col-sm-12">&nbsp;<i class="fa fa-trash fa-2x text-danger pull-right removePathSample"></i></div></div></div>';
var numPathHosts = 0;

...
var hostweed = '<div class="row col-md-12 hostweed collapsed"><i class="fa fa-arrow-circle-up fa-3x text-arrows collapse hide" data-action="collapse"></i><i class="fa fa-arrow-circle-down fa-3x expand text-arrows" data-action="expand"></i><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><span data-toggle="tooltip" title="" class="badge badge-success" data-original-title="1">1</span><label><span class="bold-red">*</span>PlantName</label><input type="text" class="form-control col-md-11 taxonText" name="plantName1" placeholder="Plant Name"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-3 col-sm-3 col-sm-3"><input type="radio" class="minimal" name="CountList1" value="Count">&nbsp;<label>Count</label></div><div class="form-group col-md-3 col-sm-3"><input type="radio" class="minimal" name="CountList1" value="List">&nbsp;<label>List</label></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label><span class="bold-red">*</span>Statistic Type</label><select class="form-control select2" name="PlantStatisticType1"></select></div><div class="form-group col-md-6 col-sm-6"><label><span class="bold-red">*</span>Count/Area</label>&nbsp;<span data-toggle="tooltip" title="2" class="badge bg-grey" data-original-title="2">1</span><br /><button type="button" class="btn btn-md btn-default qtyminus"><i class="fa fa-minus"></i></button><input type="text" class="qty" name="statTypeVal1" value="0"><button type="button" class="btn btn-md btn-default qtyplus"><i class="fa fa-plus"></i></button></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-3 col-sm-3"><input type="checkbox" name="earmark1" class="minimal">&nbsp;<label>Flag</label></div><div class="form-group col-md-3 col-sm-3"><input type="checkbox" name="extPhoto1" class="minimal">&nbsp;<label>External Photo</label></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Latitude</label><input type="text" class="form-control hostweedlat" name="latitude1" placeholder="Latitude"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Longitude</label><input type="text" class="form-control hostweedlng" name="longitude1" placeholder="Longitude"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Datum</label><select class="form-control" name="datum1"><option>WGS84</option><option>GDA94</option></select></div><div class="form-group col-md-3 col-sm-3"><button class="btn btn-md btn-default getPlantCoords"><i class="fa fa-map-marker text-info"></i>&nbsp;Get Coordinates</button></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Notes</label><textarea class="form-control" rows="6" name="notes1" style="height:60px;"></textarea></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-12 col-sm-12"><img class="pp" src="images/plant.png" id="plantPic1"><input type="text" class="hide" id="iplantPic1" value="x"><img class="pp" src="images/plant.png" id="plantPic2"><input type="text" class="hide" id="iplantPic2" value="x"><img class="pp" src="images/plant.png" id="plantPic3"><input type="text" class="hide" id="iplantPic3" value="x"><img class="pp" src="images/plant.png" id="plantPic4"><input type="text" class="hide" id="iplantPic4" value="x"><img class="pp" src="images/plant.png" id="plantPic5"><input type="text" class="hide" id="iplantPic5" value="x"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-12 col-sm-12"><i class="fa fa-trash text-danger fa-2x pull-right removePlant" data-action="removePlant"></i></div></div></div>';
var botSample = '<div class="row col-md-12 col-sm-12 sims dynarow sample collapsed"><i class="fa fa-arrow-circle-up fa-3x text-arrows collapse hide" data-action="collapse"></i><i class="fa fa-arrow-circle-down fa-3x expand text-arrows" data-action="expand"></i><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-4 col-sm-4"><label>Sample Field ID <span class="bold-red">*</span></label><input type="text" class="form-control nextid" placeholder="Sample Field ID" value="SM001" name="bsampleId"></div><div class="form-group col-md-7"><label>Additional Collectors</label><br /><input type="checkbox" name="addlCollectors" class="minimal"></div></div><div class="row col-md-12 col-sm-12 sims addlCollectors hide"><div class="form-group col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 1" name="collector1"></div><div class="form-group col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 2" name="collector2"></div><div class="form-group col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 3" name="collector3"></div></div><div class="row col-md-12 col-sm-12 sims addlCollectors hide"><div class="form-group col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 4" name="collector4"></div><div class="form-group col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 5" name="collector5"></div><div class="form-group col-md-4 col-sm-4"><input type="text" class="form-control" placeholder="Collector 6" name="collector6"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-4 col-sm-4"><label>Number Collected <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Number Collected" name="numCollected"></div><div class="form-group col-md-4 col-sm-4"><label>Linked Sample #</label><input type="text" class="form-control" placeholder="Linked Sample #" name="crossCollection"></div><div class="form-group col-md-4 col-sm-4"><label>Preliminary ID <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Preliminary ID" name="prelimID"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Latitude <span class="bold-red">*</span></label><input type="text" class="form-control samplelat" placeholder="Latitude" name="latitude"></div><div class="form-group col-md-6 col-sm-6"><label>Longitude <span class="bold-red">*</span></label><input type="text" class="form-control samplelng" placeholder="Longitude" name="longitude"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Datum</label><select class="form-control" name="datum"><option>WGS84</option><option>GDA94</option></select></div><div class="form-group col-md-6 col-sm-6"><button class="btn btn-md btn-default getSampleCoords"><i class="fa fa-map-marker text-info"></i>&nbsp;Get Coordinates</button></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Time</label><input type="text" class="form-control" placeholder="Time" name="duration"></div><div class="form-group col-md-6 col-sm-6"><label>Altitude</label><input type="text" class="form-control samplealt" placeholder="Altitude" name="altitude"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-12 col-sm-12"><label>Additional Comments</label><textarea class="form-control" rows="6" name="addlObsrvns" style="height:60px;"></textarea></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-6 col-sm-6"><label>Identified By</label><select class="form-control" name="identifiedBy"></select></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-4 col-sm-4"><label>Habit <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Habit" name="habit"></div><div class="form-group col-md-4 col-sm-4"><label>Description <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Description" name="description"></div><div class="form-group col-md-4 col-sm-4"><label>Habitat <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Habitat" name="habitat"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-4 col-sm-4"><label>Landform <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="LandForm" name="landform"></div><div class="form-group col-md-4 col-sm-4"><label>Soil/Geology <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Soil/Geology" name="soilGeology"></div><div class="form-group col-md-4 col-sm-4"><label>Abundance</label><input type="text" class="form-control" placeholder="Abundance" name="abundance"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-12 col-sm-12"><input type="checkbox" name="externalCam" class="minimal">&nbsp;&nbsp;<label>Photo(s) taken using external camera</label></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-2"><label>Preservation Type</label></div><div class="form-group col-md-3 col-sm-3"><input type="checkbox" name="BotPlantPreserve-SP" class="minimal" data-attr="BotPlantPreserve" data-code="SP" data-desc="Spirit Sample" data-seq="1">&nbsp;<label>Spirit Sample</label></div><div class="form-group col-md-3 col-sm-3"><input type="checkbox" name="BotPlantPreserve-DN" class="minimal" data-attr="BotPlantPreserve" data-code="DN" data-desc="DNA Sample" data-seq="2">&nbsp;<label>DNA Sample</label></div><div class="form-group col-md-4 col-sm-4"><input type="checkbox" name="BotPlantPreserve-O" class="minimal" data-attr="BotPlantPreserve" data-code="O" data-desc="Other" data-seq="3">&nbsp;<label>Other</label>&nbsp;<input type="text" class="form-control hide" placeholder="Other Text" name="BotPlantPreserverOtherText"></div></div><div class="row col-md-12 col-sm-12 sims"><div class="form-group col-md-12 col-sm-12"><i class="fa fa-trash fa-2x text-danger pull-right removeBotSample"></i></div></div></div>';
var plantName; var Idx;
var entobox = '<div class="row col-md-12 hostweed collapsed"><div class="row col-md-12 sims"><div class="form-group col-md-6"><span data-toggle="tooltip" title="" class="badge badge-success" data-original-title="1">1</span><label><span class="bold-red">*</span>Host Name</label><input type="text" class="form-control taxonText" placeholder="Host Name" name="hostName1"></div><div class="form-group col-md-6">&nbsp;<i class="fa fa-arrow-up fa-2x pull-right text-arrows collapse hide" data-action="collapse"></i><i class="fa fa-arrow-down fa-2x pull-right expand text-arrows" data-action="expand"></i></div></div><div class="row col-md-12 sims"><div class="form-group col-md-6"><label><span class="bold-red">*</span>Statistic Type</label><select class="form-control select2" name="PlantStatisticType1"></select></div><div class="form-group col-md-6"><label><span class="bold-red">*</span>Count/Area</label>&nbsp;<span data-toggle="tooltip" title="2" class="badge bg-grey" data-original-title="2">1</span><br /><button type="button" class="btn btn-md btn-default qtyminus"><i class="fa fa-minus"></i></button><input type="text" class="qty" name="statTypeVal1" value="0"><button type="button" class="btn btn-md btn-default qtyplus"><i class="fa fa-plus"></i></button></div></div><div class="row col-md-12 sims"><div class="form-group col-md-3"><input type="checkbox" name="earmark1" class="minimal">&nbsp;<label>Flag</label></div><div class="form-group col-md-3"><input type="checkbox" name="extPhoto1" class="minimal">&nbsp;<label>External Photo</label></div><div class="form-group col-md-6"><label><span class="bold-red">*</span>Method of Observation</label><select class="form-control" name="PlantObservationMethod1"></select></div></div><div class="row col-md-12 sims"><div class="form-group col-md-12"><label>Notes</label><textarea class="form-control" rows="6" name="notes1" style="height:60px;"></textarea></div></div><div class="row col-md-12 sims bg-target entotarget"><div class="form-group col-md-1">&nbsp;<i class="fa fa-trash text-danger" data-action="removeEntoTarget"></i><i class="fa fa-plus fa-2x pull-right text-danger" data-action="addEntoTarget"></i></div><div class="form-group col-md-11"><input type="text" name="target1" class="input-sm form-control taxonText" placeholder="Target 1"></div><div class="form-group col-md-4"><input type="text" name="Count1" class="input-sm form-control" placeholder="Target Count"></div><div class="form-group col-md-2"><input type="radio" class="minimal" name="TargetObserved1" id="optNO" value="A" Checked>&nbsp;<label>Not Observed</label></div><div class="form-group col-md-2"><input type="radio" class="minimal" name="TargetObserved1" id="optP" value="P">&nbsp;<label>Present</label></div><div class="form-group col-md-2"><input type="radio" class="minimal" name="TargetObserved1" id="optS" value="S">&nbsp;<label>Suspected</label></div><div class="form-group col-md-2"><input type="radio" class="minimal" name="TargetObserved1" id="optND" value="N">&nbsp;<label>Not Done</label></div><div class="form-group col-md-12 border-bottom"><label>Comments</label><input type="text" name="comments1" class="input-sm form-control" placeholder="Comments"></div></div><div class="row col-md-12 sims"><div class="form-group col-md-6"><label>Life Stage</label><select class="form-control select2" name="lifeStage1" style="width: 100%;"></select></div><div class="form-group col-md-6"><label>Host Plant Status</label></div></div><div class="row col-md-12 sims"><div class="form-group col-md-2"><input type="checkbox" name="hpstatus1" class="minimal">&nbsp;<label>Fruiting</label></div><div class="form-group col-md-2"><input type="checkbox" name="hpstatus2" class="minimal">&nbsp;<label>Flowering</label></div><div class="form-group col-md-2"><input type="checkbox" name="hpstatus3" class="minimal">&nbsp;<label>Flushing</label></div><div class="form-group col-md-2"><input type="checkbox" name="hpstatus4" class="minimal">&nbsp;<label>Deadwood</label></div></div><div class="row col-md-12 sims"><div class="form-group col-md-6"><label>Latitude</label><input type="text" class="form-control hostweedlat" name="latitude1" placeholder="Latitude"></div><div class="form-group col-md-6"><label>Longitude</label><input type="text" class="form-control hostweedlng" name="longitude1" placeholder="Longitude"></div></div><div class="row col-md-12 sims"><div class="form-group col-md-6"><label>Datum</label><select class="form-control" name="datum1"><option>WGS84</option><option>GDA94</option></select></div></div><div class="row col-md-12 sims"><div class="form-group col-md-12">&nbsp;<i class="fa fa-trash text-danger pull-right getPlantCoords"></i></div></div></div>';
var entotarget = '<div class="row col-md-12 sims bg-target entotarget"><div class="form-group col-md-1">&nbsp;<i class="fa fa-trash text-danger" data-action="removeEntoTarget"></i><i class="fa fa-plus fa-2x pull-right text-danger" data-action="addEntoTarget"></i></div><div class="form-group col-md-11"><input type="text" name="target1" class="input-sm form-control taxonText" placeholder="Target 1"></div><div class="form-group col-md-4"><input type="text" name="Count1" class="input-sm form-control" placeholder="Target Count"></div><div class="form-group col-md-2"><input type="radio" class="minimal" name="TargetObserved1" id="optNO" value="A" Checked>&nbsp;<label>Not Observed</label></div><div class="form-group col-md-2"><input type="radio" class="minimal" name="TargetObserved1" id="optP" value="P">&nbsp;<label>Present</label></div><div class="form-group col-md-2"><input type="radio" class="minimal" name="TargetObserved1" id="optS" value="S">&nbsp;<label>Suspected</label></div><div class="form-group col-md-2"><input type="radio" class="minimal" name="TargetObserved1" id="optND" value="N">&nbsp;<label>Not Done</label></div><div class="form-group col-md-12 border-bottom"><label>Comments</label><input type="text" name="comments1" class="input-sm form-control" placeholder="Comments"></div></div>';
var entosample = '<div class="row col-md-12 sims dynarow sample collapsed"><div class="row col-md-12 sims"><div class="form-group col-md-3"><label>Sample Field ID <span class="bold-red">*</span></label><input type="text" class="form-control nextid" placeholder="Sample Field ID" value="SM001" name="esampleId"></div><div class="form-group col-md-3"><label>Additional Collectors</label><br /><input type="checkbox" name="addlCollectors" class="minimal"></div><div class="form-group col-md-6">&nbsp;<i class="fa fa-arrow-up fa-2x pull-right text-arrows collapse hide" data-action="collapse"></i><i class="fa fa-arrow-down fa-2x pull-right expand text-arrows" data-action="expand"></i></div></div><div class="row col-md-12 sims addlCollectors hide"><div class="form-group col-md-4"><input type="text" class="form-control" placeholder="Collector 1" name="collector1"></div><div class="form-group col-md-4"><input type="text" class="form-control" placeholder="Collector 2" name="collector2"></div><div class="form-group col-md-4"><input type="text" class="form-control" placeholder="Collector 3" name="collector3"></div></div><div class="row col-md-12 sims addlCollectors hide"><div class="form-group col-md-4"><input type="text" class="form-control" placeholder="Collector 4" name="collector4"></div><div class="form-group col-md-4"><input type="text" class="form-control" placeholder="Collector 5" name="collector5"></div><div class="form-group col-md-4"><input type="text" class="form-control" placeholder="Collector 6" name="collector6"></div></div><div class="row col-md-12 sims"><div class="form-group col-md-4"><label>Number Collected <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Number Collected" name="numCollected"></div><div class="form-group col-md-4"><label>Linked Sample #</label><input type="text" class="form-control" placeholder="Linked Sample #" name="crossCollection"></div><div class="form-group col-md-4"><label>Preliminary ID <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Preliminary ID" name="prelimID"></div></div><div class="row col-md-12 sims"><div class="form-group col-md-4"><label>Latitude <span class="bold-red">*</span></label><input type="text" class="form-control samplelat" placeholder="Latitude" name="latitude"></div><div class="form-group col-md-4"><label>Longitude <span class="bold-red">*</span></label><input type="text" class="form-control samplelng" placeholder="Longitude" name="longitude"></div></div><div class="row col-md-12 sims"><div class="form-group col-md-6"><label>Datum</label><select class="form-control" name="datum"><option>WGS84</option><option>GDA94</option></select></div><div class="form-group col-md-6"><button class="btn btn-md btn-default getSampleCoords"><i class="fa fa-map-marker text-info"></i>&nbsp;Get Coordinates</button></div></div><div class="row col-md-12 sims"><div class="form-group col-md-4"><label>Time</label><input type="text" class="form-control" placeholder="Time" name="duration"></div><div class="form-group col-md-4"><label>Altitude</label><input type="text" class="form-control samplealt" placeholder="Altitude" name="altitude"></div><div class="form-group col-md-4"><label>Collection Method</label><select class="form-control" name="EntoCollectionMethod"></select></div></div><div class="row col-md-12 sims"><div class="form-group col-md-12"><label>Additional Comments</label><textarea class="form-control" rows="6" name="addlObsrvns" style="height:30px;"></textarea></div></div><div class="row col-md-12 sims"><div class="form-group col-md-2"><label>Host/Other <span class="bold-red">*</span></label></div><div class="form-group col-md-2"><input type="radio" name="hostother" class="minimal">&nbsp;<label>Host</label></div><div class="form-group col-md-2"><input type="radio" name="hostother" class="minimal">&nbsp;<label>Other</label></div><div class="form-group col-md-6"><input type="text" class="form-control" placeholder="Other Name" name="otheName"></div></div><div class="row col-md-12 sims"><div class="form-group col-md-6"><label>Identified By</label><select class="form-control" name="identifiedBy"></select></div></div><div class="row col-md-12 sims"><div class="form-group col-md-6"><label>Plant Part</label></div><div class="form-group col-md-3"><input type="checkbox" name="plantPart" class="minimal" value="LE">&nbsp;<label>Leaves</label></div><div class="form-group col-md-3"><input type="checkbox" name="plantPart" class="minimal" value="LE">&nbsp;<label>Flower</label></div><div class="form-group col-md-3"><input type="checkbox" name="plantPart" class="minimal" value="FR">&nbsp;<label>Fruit</label></div><div class="form-group col-md-3"><input type="checkbox" name="plantPart" class="minimal" value="SE">&nbsp;<label>Seeds</label></div><div class="form-group col-md-3"><input type="checkbox" name="plantPart" class="minimal" value="ST">&nbsp;<label>Stem</label></div></div><div class="row col-md-12 sims"><div class="form-group col-md-3"><input type="checkbox" name="plantPart" class="minimal" value="SH">&nbsp;<label>Shoot</label></div><div class="form-group col-md-3"><input type="checkbox" name="plantPart" class="minimal" value="RO">&nbsp;<label>Root</label></div><div class="form-group col-md-3"><input type="checkbox" name="plantPart" class="minimal" value="BR">&nbsp;<label>Branch</label></div><div class="form-group col-md-3"><input type="checkbox" name="plantPart" class="minimal" value="TR">&nbsp;<label>Trunk</label></div></div><div class="row col-md-12 sims"><div class="form-group col-md-6"><label>Preservation Type</label></div><div class="form-group col-md-4"><input type="checkbox" name="EntoPlantPreserve" class="minimal" value="W7">&nbsp;<label>Wet (Ethanol 70-80%)</label></div><div class="form-group col-md-4"><input type="checkbox" name="EntoPlantPreserve" class="minimal" value="W8">&nbsp;<label>Wet (Ethanol>80%)</label></div><div class="form-group col-md-3"><input type="checkbox" name="EntoPlantPreserve" class="minimal" value="RE">&nbsp;<label>Rearing</label></div></div><div class="row col-md-12 sims"><div class="form-group col-md-4"><input type="checkbox" name="EntoPlantPreserve" class="minimal" value="DR">&nbsp;<label>Dry</label></div><div class="form-group col-md-3"><input type="checkbox" name="EntoPlantPreserve" class="minimal" value="FT">&nbsp;<label>FTA Card</label></div><div class="form-group col-md-3"><input type="checkbox" name="EntoPlantPreserve" class="minimal" value="O">&nbsp;<label>Other</label></div><div class="form-group col-md-3"><input type="text" class="form-control" placeholder="Other Preservation Type" name="othPreserveType"></div></div><div class="row col-md-12 sims"><div class="form-group col-md-4"><label>%Infested </label><select class="form-control" name="EntoInfestedPct"></select></div><div class="form-group col-md-4"><label>Damage Level </label><select class="form-control" name="EntoDamageLevel"></select></div><div class="form-group col-md-4"><label>Pest Level </label><select class="form-control" name="EntoPestLevel"></select></div></div><div class="row col-md-12 sims"><div class="form-group col-md-6"><label>Life Stage</label></div><div class="form-group col-md-3"><input type="checkbox" name="EntoLifeStage" class="minimal" value="A">&nbsp;<label>Adult</label></div><div class="form-group col-md-3"><input type="checkbox" name="EntoLifeStage" class="minimal" value="E">&nbsp;<label>Egg</label></div><div class="form-group col-md-3"><input type="checkbox" name="EntoLifeStage" class="minimal" value="I">&nbsp;<label>Immature</label></div><div class="form-group col-md-3"><input type="checkbox" name="EntoLifeStage" class="minimal" value="P">&nbsp;<label>Pupae</label></div></div><div class="row col-md-12 sims"><div class="form-group col-md-12"><input type="checkbox" name="externalCam" class="minimal">&nbsp;&nbsp;<label>Photo(s) taken using external camera</label></div></div><div class="row col-md-12 sims"><div class="form-group col-md-12">&nbsp;<i class="fa fa-trash text-danger pull-right removeEntoSample"></i></div></div></div>';
var numEntoHosts = 0;
var numEntoTargets = 0;
var hostName;
var pathbox = '<div class="row col-md-12 hostweed collapsed"><div class="row col-md-12 sims"><div class="form-group col-md-6">&nbsp;<i class="fa fa-arrow-up fa-2x pull-right text-arrows collapse hide" data-action="collapse"></i><i class="fa fa-arrow-down fa-2x pull-right expand text-arrows" data-action="expand"></i></div><div class="form-group col-md-6"><span data-toggle="tooltip" title="" class="badge badge-success" data-original-title="1">1</span><label><span class="bold-red">*</span>Host Name</label><input type="text" class="form-control taxonText" placeholder="Host Name" name="hostName1"></div></div><div class="row col-md-12 sims"><div class="form-group col-md-6"><label><span class="bold-red">*</span>Statistic Type</label><select class="form-control select2" name="PlantStatisticType1"><option selected="selected">Statistic Type</option><option value="C">Count</option><option value="A">Area (m2)</option></select></div><div class="form-group col-md-6"><label><span class="bold-red">*</span>Count/Area</label>&nbsp;<span data-toggle="tooltip" title="2" class="badge bg-grey" data-original-title="2">1</span><br /><button type="button" class="btn btn-md btn-default qtyminus"><i class="fa fa-minus"></i></button><input type="text" class="qty" name="statTypeVal1" value="0"><button type="button" class="btn btn-md btn-default qtyplus"><i class="fa fa-plus"></i></button></div></div><div class="row col-md-12 sims"><div class="form-group col-md-3"><input type="checkbox" name="earmark1" class="minimal">&nbsp;<label>Flag</label></div><div class="form-group col-md-3"><input type="checkbox" name="extPhoto1" class="minimal">&nbsp;<label>External Photo</label></div><div class="form-group col-md-6"><label><span class="bold-red">*</span>Method of Observation</label><select class="form-control" name="mob1"><option>Direct</option><option>Sweep</option><option>Beat</option><option>Dissection</option><option>Other</option></select></div></div><div class="row col-md-12 sims bg-target pathtarget"><div class="form-group col-md-1">&nbsp;<i class="fa fa-trash pull-right text-danger" data-action="removePathTarget"></i><i class="fa fa-plus fa-2x pull-right text-danger" data-action="addPathTarget"></i></div><div class="form-group col-md-11"><input type="text" name="target1" class="input-sm form-control taxonText" placeholder="Target 1"></div><div class="form-group col-md-4"><input type="text" name="Count1" class="input-sm form-control" placeholder="Target Count"></div><div class="form-group col-md-2"><input type="radio" class="minimal" name="optTarget1" id="optNO" value="Not Observed" Checked>&nbsp;<label>Not Observed</label></div><div class="form-group col-md-2"><input type="radio" class="minimal" name="optTarget1" id="optP" value="Present">&nbsp;<label>Present</label></div><div class="form-group col-md-2"><input type="radio" class="minimal" name="optTarget1" id="optS" value="Suspected">&nbsp;<label>Suspected</label></div><div class="form-group col-md-2"><input type="radio" class="minimal" name="optTarget1" id="optND" value="Not Done">&nbsp;<label>Not Done</label></div><div class="form-group col-md-12 border-bottom"><label>Comments</label><input type="text" name="comments1" class="input-sm form-control" placeholder="Comments"></div></div><div class="row col-md-12 sims"><div class="form-group col-md-6"><label>Life Stage</label><select class="form-control select2" name="lifeStage1" style="width: 100%;"><option selected="selected">Seedling</option><option>Immature</option><option>Mature</option></select></div><div class="form-group col-md-6"><label>Notes</label><textarea class="form-control" rows="6" name="notes1"></textarea></div></div><div class="row col-md-12 sims"><div class="form-group col-md-6"><label>Latitude</label><input type="text" class="form-control hostweedlat" name="latitude1" placeholder="Latitude"></div><div class="form-group col-md-6"><label>Longitude</label><input type="text" class="form-control hostweedlng" name="longitude1" placeholder="Longitude"></div></div><div class="row col-md-12 sims"><div class="form-group col-md-6"><label>Datum</label><select class="form-control" name="datum1"><option>WGS84</option><option>GDA94</option></select></div></div><div class="row col-md-12 sims"><div class="form-group col-md-12">&nbsp;<i class="fa fa-trash text-danger pull-right getPlantCoords"></i></div></div></div>';
var pathtarget = '<div class="row col-md-12 sims bg-target pathtarget"><div class="form-group col-md-1">&nbsp;<i class="fa fa-trash text-danger" data-action="removePathTarget"></i><i class="fa fa-plus fa-2x pull-right text-danger" data-action="addPathTarget"></i></div><div class="form-group col-md-11"><input type="text" name="target1" class="input-sm form-control taxonText" placeholder="Target 1"></div><div class="form-group col-md-4"><input type="text" name="Count1" class="input-sm form-control" placeholder="Target Count"></div><div class="form-group col-md-2"><input type="radio" class="minimal" name="optTarget1" id="optNO" value="Not Observed" Checked>&nbsp;<label>Not Observed</label></div><div class="form-group col-md-2"><input type="radio" class="minimal" name="optTarget1" id="optP" value="Present">&nbsp;<label>Present</label></div><div class="form-group col-md-2"><input type="radio" class="minimal" name="optTarget1" id="optS" value="Suspected">&nbsp;<label>Suspected</label></div><div class="form-group col-md-2"><input type="radio" class="minimal" name="optTarget1" id="optND" value="Not Done">&nbsp;<label>Not Done</label></div><div class="form-group col-md-12 border-bottom"><label>Comments</label><input type="text" name="comments1" class="input-sm form-control" placeholder="Comments"></div></div>';
var pathsample = '<div class="row col-md-12 sims dynarow sample collapsed"><div class="row col-md-12 sims"><div class="form-group col-md-6">&nbsp;<i class="fa fa-arrow-up fa-2x pull-right text-arrows collapse hide" data-action="collapse"></i><i class="fa fa-arrow-down fa-2x pull-right expand text-arrows" data-action="expand"></i></div><div class="form-group col-md-3"><label>Sample Field ID <span class="bold-red">*</span></label><input type="text" class="form-control nextid" placeholder="Sample Field ID" value="SM001" name="psampleId"></div><div class="form-group col-md-3"><label>Additional Collectors</label><br /><input type="checkbox" name="addlCollectors" class="minimal"></div></div><div class="row col-md-12 sims"><div class="form-group col-md-4"><label>Number Collected <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Number Collected" name="numCollected"></div><div class="form-group col-md-4"><label>Linked Sample #</label><input type="text" class="form-control" placeholder="Linked Sample #" name="crossCollection"></div><div class="form-group col-md-4"><label>Preliminary ID <span class="bold-red">*</span></label><input type="text" class="form-control" placeholder="Preliminary ID" name="prelimID"></div></div><div class="row col-md-12 sims"><div class="form-group col-md-4"><label>Latitude <span class="bold-red">*</span></label><input type="text" class="form-control samplelat" placeholder="Latitude" name="latitude"></div><div class="form-group col-md-4"><label>Longitude <span class="bold-red">*</span></label><input type="text" class="form-control samplelng" placeholder="Longitude" name="longitude"></div></div><div class="row col-md-12 sims"><div class="form-group col-md-6"><label>Datum</label><select class="form-control" name="datum"><option>WGS84</option><option>GDA94</option></select></div><div class="form-group col-md-6"><button class="btn btn-md btn-default getSampleCoords"><i class="fa fa-map-marker text-info"></i>&nbsp;Get Coordinates</button></div></div><div class="row col-md-12 sims"><div class="form-group col-md-6"><label>Time</label><input type="text" class="form-control" placeholder="Time" name="duration"></div><div class="form-group col-md-6"><label>Altitude</label><input type="text" class="form-control samplealt" placeholder="Altitude" name="altitude"></div></div><div class="row col-md-12 sims"><div class="form-group col-md-12"><label>Additional Comments</label><textarea class="form-control" rows="6" name="addlObsrvns" style="height:30px;"></textarea></div></div><div class="row col-md-12 sims"><div class="form-group col-md-6"><label>Host/Other <span class="bold-red">*</span></label></div><div class="form-group col-md-6"><input type="text" class="form-control" placeholder="Other Name" name="otheName"></div><div class="form-group col-md-6"><label>Identified By</label><select class="form-control" name="identifiedBy"><option>User 1</option><option>User 2</option></select></div></div><div class="row col-md-12 sims"><div class="form-group col-md-6"><label>Plant Part</label></div><div class="form-group col-md-3"><input type="checkbox" name="plantPart" class="minimal">&nbsp;<label>Leaves</label></div><div class="form-group col-md-3"><input type="checkbox" name="plantPart" class="minimal">&nbsp;<label>Flower</label></div><div class="form-group col-md-3"><input type="checkbox" name="plantPart" class="minimal">&nbsp;<label>Fruit</label></div><div class="form-group col-md-3"><input type="checkbox" name="plantPart" class="minimal">&nbsp;<label>Seeds</label></div></div><div class="row col-md-12 sims"><div class="form-group col-md-3"><input type="checkbox" name="plantPart" class="minimal">&nbsp;<label>Stem</label></div><div class="form-group col-md-3"><input type="checkbox" name="plantPart" class="minimal">&nbsp;<label>Shoot</label></div><div class="form-group col-md-3"><input type="checkbox" name="plantPart" class="minimal">&nbsp;<label>Root</label></div><div class="form-group col-md-3"><input type="checkbox" name="plantPart" class="minimal">&nbsp;<label>Branch</label></div></div><div class="row col-md-12 sims"><div class="form-group col-md-3"><input type="checkbox" name="plantPart" class="minimal">&nbsp;<label>Trunk</label></div><div class="form-group col-md-3"><input type="checkbox" name="plantPart" class="minimal">&nbsp;<label>Whole Plant</label></div><div class="form-group col-md-3"><input type="checkbox" name="plantPart" class="minimal">&nbsp;<label>Soil</label></div></div><div class="row col-md-12 sims"><div class="form-group col-md-6"><label>Symptoms</label><input type="text" class="form-control samplelat" placeholder="Symptoms" name="symptoms"></div></div><div class="row col-md-12 sims"><div class="form-group col-md-6"><label>Preservation Type <span class="bold-red">*</span></label></div><div class="form-group col-md-3"><input type="checkbox" name="preservationType" class="minimal">&nbsp;<label>Fresh</label></div><div class="form-group col-md-3"><input type="checkbox" name="preservationType" class="minimal">&nbsp;<label>Pressed Specimen</label></div><div class="form-group col-md-3"><input type="checkbox" name="preservationType" class="minimal">&nbsp;<label>Dessicate</label></div></div><div class="row col-md-12 sims"><div class="form-group col-md-3"><input type="checkbox" name="preservationType" class="minimal">&nbsp;<label>Extract</label></div><div class="form-group col-md-3"><input type="checkbox" name="preservationType" class="minimal">&nbsp;<label>Isolation</label></div><div class="form-group col-md-3"><input type="checkbox" name="preservationType" class="minimal">&nbsp;<label>Other</label></div><div class="form-group col-md-3"><input type="text" class="form-control" placeholder="Other Preservation Type" name="othPresType"></div></div><div class="row col-md-12 sims"><div class="form-group col-md-6"><label>Incidence <span class="bold-red">*</span></label><select class="form-control" name="incidence"><option>Incidence 1</option><option>Incidence 1</option></select></div><div class="form-group col-md-6"><label>Severity <span class="bold-red">*</span></label><select class="form-control" name="severity"><option>Severity 1</option><option>Severity 1</option></select></div></div><div class="row col-md-12 sims"><div class="form-group col-md-12"><input type="checkbox" name="externalCam" class="minimal">&nbsp;&nbsp;<label>Photo(s) taken using external camera</label></div></div><div class="row col-md-12 sims"><div class="form-group col-md-12">&nbsp;<i class="fa fa-trash text-danger pull-right removePathSample"></i></div></div></div>';
var numPathHosts = 0;
